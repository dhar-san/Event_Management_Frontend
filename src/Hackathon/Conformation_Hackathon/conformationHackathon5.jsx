...
function ConformationHackathon5() {
  ...
  const packages = [
    { id: 'team', name: 'Team Registration', price: 3500, description: 'Per team (2-5 members)' },
    { id: 'individual', name: 'Individual', price: 1400, description: 'Single participant', popular: true },
    { id: 'student', name: 'Student', price: 900, description: 'With valid student ID' },
    { id: 'early', name: 'Early Bird', price: 2500, description: 'Limited time offer' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathon_fest5" className="back-button">
