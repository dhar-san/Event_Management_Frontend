...
function ConformationHackathon6() {
  ...
  const packages = [
    { id: 'team', name: 'Team Registration', price: 4000, description: 'Per team (2-5 members)' },
    { id: 'individual', name: 'Individual', price: 1600, description: 'Single participant', popular: true },
    { id: 'student', name: 'Student', price: 1000, description: 'With valid student ID' },
    { id: 'early', name: 'Early Bird', price: 2800, description: 'Limited time offer' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathon_fest6" className="back-button">
...
export default ConformationHackathon6;