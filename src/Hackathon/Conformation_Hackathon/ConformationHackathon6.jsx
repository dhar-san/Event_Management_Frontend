...
function ConformationHackathon6() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Participant', price: 1999, description: 'Premium seating + mentor access + meals' },
    { id: 'standard', name: 'Standard Participant', price: 1299, description: 'General participation + meals', popular: true },
    { id: 'student', name: 'Student Participant', price: 799, description: 'Discounted rate for students' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathonpage6" className="back-button">
