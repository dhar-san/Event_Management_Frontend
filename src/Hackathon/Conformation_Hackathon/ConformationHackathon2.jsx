...
function ConformationHackathon2() {
  ...
  const packages = [
    { id: 'team', name: 'Team Registration', price: 1800, description: 'Per team (2-4 members)' },
    { id: 'individual', name: 'Individual', price: 700, description: 'Single participant', popular: true },
    { id: 'student', name: 'Student', price: 400, description: 'With valid student ID' },
    { id: 'early', name: 'Early Bird', price: 1300, description: 'Limited time offer' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathon_fest2" className="back-button">
