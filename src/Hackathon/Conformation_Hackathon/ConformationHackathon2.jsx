...
function ConformationHackathon2() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Participant', price: 999, description: 'Premium seating + mentor access + meals' },
    { id: 'standard', name: 'Standard Participant', price: 599, description: 'General participation + meals', popular: true },
    { id: 'student', name: 'Student Participant', price: 399, description: 'Discounted rate for students' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathonpage2" className="back-button">
