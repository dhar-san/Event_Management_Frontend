...
function ConformationHackathon3() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Participant', price: 599, description: 'Premium seating + mentor access + meals' },
    { id: 'standard', name: 'Standard Participant', price: 399, description: 'General participation + meals', popular: true },
    { id: 'student', name: 'Student Participant', price: 299, description: 'Discounted rate for students' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathonpage3" className="back-button">
