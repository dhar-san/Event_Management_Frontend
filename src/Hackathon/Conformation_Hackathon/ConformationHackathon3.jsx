...
function ConformationHackathon3() {
  ...
  const eventDetails = {
    ...
    organizer: "Global Innovation Lab",
  ...
  const packages = [
    { id: 'team', name: 'Team Registration', price: 3000, description: 'Per team (2-6 members)' },
    { id: 'individual', name: 'Individual', price: 1200, description: 'Single participant', popular: true },
    { id: 'student', name: 'Student', price: 800, description: 'With valid student ID' },
    { id: 'early', name: 'Early Bird', price: 2200, description: 'Limited time offer' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathon_fest3" className="back-button">
...
export default ConformationHackathon3;