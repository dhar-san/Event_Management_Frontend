...
function ConformationHackathon4() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Participant', price: 1499, description: 'Premium seating + mentor access + meals' },
    { id: 'standard', name: 'Standard Participant', price: 999, description: 'General participation + meals', popular: true },
    { id: 'student', name: 'Student Participant', price: 699, description: 'Discounted rate for students' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hackathonpage4" className="back-button">
