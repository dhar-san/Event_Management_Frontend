...
function ConformationHackathon1() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Participant', price: 1500, description: 'Premium seating + mentor access + meals' },
    { id: 'standard', name: 'Standard Participant', price: 799, description: 'General participation + meals', popular: true },
    { id: 'student', name: 'Student Participant', price: 500, description: 'Discounted rate for students' }
  ];
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          <div className="ticket-header">
            ...
            <p>Your hackathon registration has been confirmed</p>
          </div>
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  <li>Please arrive 30 minutes before the hackathon starts</li>
                  <li>Bring your laptop and necessary development tools</li>
          ...
          <div className="action-buttons">
            <Link to="/hackathon_page" className="btn btn-primary">Browse More Hackathons</Link>
        ...
        <div className="confirmation-content">
          ...
          <div className="booking-sections">
            <div className="package-selection">
              <h2>💻 Code Your Way, Win the Day 🏆</h2>
