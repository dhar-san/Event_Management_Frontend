...
function Conformation_Auction1() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Art & Antiques Auction",
    organizer: "Heritage Auction House",
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          <div className="ticket-header">
            ...
            <p>Your auction registration has been confirmed</p>
          </div>
          ...
          <div className="action-buttons">
            <Link to="/auction_page" className="btn btn-primary">Browse More Auctions</Link>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auction1" className="back-button">
...
export default Conformation_Auction1