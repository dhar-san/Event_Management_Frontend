...
import { FaTicketAlt, FaCreditCard, FaMobile, FaWallet, FaUniversity, FaCheck, FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaGavel } from 'react-icons/fa';

function Conformation_Auction4() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Rare Books & Manuscripts Auction",
    organizer: "Literary Heritage Auction",
    venue: "Connemara Library, Chennai",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Bidder', price: 2500, description: 'Premium seating with catalog and refreshments' },
    { id: 'standard', name: 'Standard Bidder', price: 1200, description: 'General admission with catalog', popular: true },
    { id: 'observer', name: 'Observer Pass', price: 600, description: 'Viewing only, no bidding rights' }
  ];
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          <div className="ticket-header">
            ...
            <p>Your auction registration has been confirmed successfully</p>
          </div>
            ...
            <div className="ticket-body">
              <div className="ticket-section">
                ...
                <div className="ticket-info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span className="value">AU{Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
                  </div>
                  <div className="info-item">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  ...
                  <li>Bidding paddle will be provided at the venue</li>
          ...
          <div className="action-buttons">
            <Link to="/auction_page" className="btn btn-primary">Browse More Events</Link>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auctionpage4" className="back-button">
...
export default Conformation_Auction4;