...
function Conformation_Auction5() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Watches & Timepieces Auction",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Bidder', price: 3500, description: 'Premium seating with catalog and refreshments' },
    { id: 'standard', name: 'Standard Bidder', price: 1800, description: 'General admission with catalog', popular: true },
    { id: 'observer', name: 'Observer Pass', price: 900, description: 'Viewing only, no bidding rights' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auctionpage5" className="back-button">
...
export default Conformation_Auction5;