...
function Conformation_Auction6() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Electronics & Gadgets Auction",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Bidder', price: 2000, description: 'Premium seating with catalog and refreshments' },
    { id: 'standard', name: 'Standard Bidder', price: 1000, description: 'General admission with catalog', popular: true },
    { id: 'observer', name: 'Observer Pass', price: 500, description: 'Viewing only, no bidding rights' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auctionpage6" className="back-button">
...
export default Conformation_Auction6;