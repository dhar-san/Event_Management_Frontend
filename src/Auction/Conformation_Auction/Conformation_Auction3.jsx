...
function Conformation_Auction3() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Vintage Cars & Automobiles Auction",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Bidder', price: 4000, description: 'Premium seating with catalog and refreshments' },
    { id: 'standard', name: 'Standard Bidder', price: 2000, description: 'General admission with catalog', popular: true },
    { id: 'observer', name: 'Observer Pass', price: 1000, description: 'Viewing only, no bidding rights' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auctionpage3" className="back-button">
...
export default Conformation_Auction3;