...
function Conformation_Auction2() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Bidder', price: 3000, description: 'Premium seating with catalog and refreshments' },
    { id: 'standard', name: 'Standard Bidder', price: 1500, description: 'General admission with catalog', popular: true },
    { id: 'observer', name: 'Observer Pass', price: 800, description: 'Viewing only, no bidding rights' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/auctionpage2" className="back-button">
...
export default Conformation_Auction2;