...
function Conformation_Event1() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Pass', price: 5000, description: 'Premium seating with networking lunch' },
    { id: 'standard', name: 'Standard Pass', price: 2500, description: 'Full day access with lunch', popular: true },
    { id: 'student', name: 'Student Pass', price: 1500, description: 'Discounted rate for students' }
  ];
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          ...
          <div className="action-buttons">
            <Link to="/events_page" className="btn btn-primary">Browse More Events</Link>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/event1" className="back-button">
...
export default Conformation_Event1