...
function Anirudh_concert() {
  ...
  const eventDetails = {
    ...
    venue: "MARG Swarnabhoomi (ECR), Chennai, Tamil Nadu",
    date: "23rd December 2025",
    time: "6:30 PM – 11:00 PM",
    crowd: "20,000+ people",
    rating: 4.9,
    image: "https://i.pinimg.com/736x/e9/22/b0/e922b0216d32439c5dd15418b5a0094e.jpg",
    description: "Experience the musical genius of Anirudh Ravichander in this spectacular world tour featuring his biggest hits and electrifying performances.",
    guestArtists: [
      "Jonita Gandhi",
      "Adithya RK",
      "Shaktisree Gopalan",
      ...
      <div className="event-content">
        <div className="event-container">
          ...
          <div className="action-section">
            <Link to="/conformationPageAnirudth" className="btn btn-primary btn-large">
