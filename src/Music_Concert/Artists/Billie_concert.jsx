...
function Billie_concert() {
  ...
  const eventDetails = {
    ...
    description: "Experience the revolutionary sound of Billie Eilish in this spectacular world tour featuring her latest hits and mesmerizing performances.",
    guestArtists: [
      "Lil Nas X",
      "Bruno Mars",
      "Justin Bieber",
      ...
      <div className="event-content">
        <div className="event-container">
          ...
          <div className="action-section">
            <Link to="/conformationPageBillie" className="btn btn-primary btn-large">
