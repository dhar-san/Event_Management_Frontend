...
function ConfomationHiphop() {
  ...
  const packages = [
    { id: 'seating', name: 'Seating', price: 9999, description: 'Premium seating with best views' },
    { id: 'platinum', name: 'Platinum', price: 7500, description: 'Standing area with premium access', popular: true },
    { id: 'gold', name: 'Gold', price: 4500, description: 'Great view with good acoustics' },
    { id: 'bronze', name: 'Bronze', price: 1500, description: 'General admission standing' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/hiphop_concert" className="back-button">
...
export default ConfomationHiphop;
