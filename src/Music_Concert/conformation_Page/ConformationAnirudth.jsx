...
function ConformationAnirudth() {
  ...
  const eventDetails = {
    title: "HUKUM WORLD TOUR",
    artist: "Anirudh Ravichander",
    venue: "MARG Swarnabhoomi (ECR), Chennai",
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 12000, description: 'Front row seating with meet & greet' },
    { id: 'platinum', name: 'Platinum', price: 8500, description: 'Premium seating with great views', popular: true },
    { id: 'gold', name: 'Gold', price: 5500, description: 'Excellent view with good acoustics' },
    { id: 'silver', name: 'Silver', price: 2500, description: 'General admission with good sound' }
  ];
