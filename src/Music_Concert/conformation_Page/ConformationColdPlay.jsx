...
function ConformationColdPlay() {
  ...
  const packages = [
    ...
    { id: 'platinum', name: 'Platinum', price: 8000, description: 'Premium seating with great views', popular: true },
    { id: 'gold', name: 'Gold', price: 6000, description: 'Excellent view with good acoustics' },
    { id: 'silver', name: 'Silver', price: 4000, description: 'General admission with good sound' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/coldplay_concert" className="back-button">
