...
function ConformationBillie() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 15000, description: 'Front row seating with meet & greet' },
    { id: 'platinum', name: 'Platinum', price: 10000, description: 'Premium seating with great views', popular: true },
    { id: 'gold', name: 'Gold', price: 7500, description: 'Excellent view with good acoustics' },
    { id: 'silver', name: 'Silver', price: 5000, description: 'General admission with good sound' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/billie_concert" className="back-button">
