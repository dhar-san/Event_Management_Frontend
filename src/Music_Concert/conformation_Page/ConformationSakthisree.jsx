...
function ConformationSakthisree() {
  ...
  const eventDetails = {
    ...
    venue: "Music Academy Open Grounds, Chennai",
  ...
  const packages = [
    { id: 'premium', name: 'Premium', price: 3500, description: 'Front row seating with best acoustics' },
    { id: 'standard', name: 'Standard', price: 2000, description: 'Great view with excellent sound quality', popular: true },
    { id: 'economy', name: 'Economy', price: 1200, description: 'General seating with good acoustics' },
    { id: 'student', name: 'Student', price: 800, description: 'Special pricing for students with valid ID' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/sakthisree_concert" className="back-button">
...
export default ConformationSakthisree;