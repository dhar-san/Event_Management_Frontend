...
function ConformationDonation6() {
  const [selectedPackage, setSelectedPackage] = useState('');
  const [selectedPayment, setSelectedPayment] = useState('');
  const [showTicket, setShowTicket] = useState(false);

  const eventDetails = {
    title: "Senior Citizens Care Fund",
  ...
  const packages = [
    { id: 'platinum', name: 'Platinum Caregiver', price: 18000, description: 'Support 8 senior citizens for a year' },
    { id: 'gold', name: 'Gold Caregiver', price: 9000, description: 'Support 4 senior citizens for a year', popular: true },
    { id: 'silver', name: 'Silver Caregiver', price: 4500, description: 'Support 2 senior citizens for a year' },
    { id: 'bronze', name: 'Bronze Caregiver', price: 2000, description: 'Support medical care and supplies' }
  ];
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  <li>Your donation will help provide care for senior citizens</li>
                  <li>You will receive updates on the seniors you support</li>
                  <li>Tax exemption certificate will be sent to your email</li>
                  <li>Thank you for caring for our elders</li>
                </ul>
              </div>
            </div>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/donationpage6" className="back-button">
...
export default ConformationDonation6;
