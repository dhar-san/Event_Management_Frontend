...
import { FaTicketAlt, FaCreditCard, FaMobile, FaWallet, FaUniversity, FaCheck, FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaUsers, FaDollarSign } from 'react-icons/fa';
...
function ConformationDonation6() {
  ...
  const packages = [
    { id: 'supporter', name: 'Supporter', price: 0, description: 'Attend and learn about the cause' },
    { id: 'contributor', name: 'Contributor', price: 200, description: 'Make a meaningful contribution', popular: true },
    { id: 'sponsor', name: 'Sponsor', price: 1000, description: 'Support major initiatives' },
    { id: 'benefactor', name: 'Benefactor', price: 5000, description: 'Major supporter with special recognition' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/donation6" className="back-button">
