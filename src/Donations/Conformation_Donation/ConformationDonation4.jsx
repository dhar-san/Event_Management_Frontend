...
import { FaTicketAlt, FaCreditCard, FaMobile, FaWallet, FaUniversity, FaCheck, FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaUsers, FaHeart } from 'react-icons/fa';

function ConformationDonation4() {
  ...
  const packages = [
    { id: 'donor', name: 'Blood Donor', price: 0, description: 'Donate blood and save lives' },
    { id: 'volunteer', name: 'Volunteer', price: 0, description: 'Help organize and support the event', popular: true },
    { id: 'supporter', name: 'Supporter', price: 0, description: 'Spread awareness and encourage others' },
    { id: 'sponsor', name: 'Sponsor', price: 500, description: 'Support the cause financially' }
  ];
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  ...
                  <li>For blood donors: Ensure you have eaten well and are hydrated</li>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/donation4" className="back-button">
...
export default ConformationDonation4;