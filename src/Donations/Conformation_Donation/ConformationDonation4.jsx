...
function ConformationDonation4() {
  ...
  const packages = [
    { id: 'platinum', name: 'Platinum Healer', price: 25000, description: 'Support 5 critical medical cases' },
    { id: 'gold', name: 'Gold Healer', price: 12000, description: 'Support 2 critical medical cases', popular: true },
    { id: 'silver', name: 'Silver Healer', price: 6000, description: 'Support 1 critical medical case' },
    { id: 'bronze', name: 'Bronze Healer', price: 3000, description: 'Support medical supplies and equipment' }
  ];
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  <li>Your donation will help save lives in medical emergencies</li>
                  <li>You will receive updates on the patients you support</li>
                  <li>Tax exemption certificate will be sent to your email</li>
                  <li>Thank you for helping save lives</li>
                </ul>
              </div>
            </div>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/donationpage4" className="back-button">
