...
function ConformationDonation2() {
  ...
  const packages = [
    { id: 'platinum', name: 'Platinum Supporter', price: 15000, description: 'Support 10 animals for a year' },
    { id: 'gold', name: 'Gold Supporter', price: 8000, description: 'Support 5 animals for a year', popular: true },
    { id: 'silver', name: 'Silver Supporter', price: 4000, description: 'Support 2 animals for a year' },
    { id: 'bronze', name: 'Bronze Supporter', price: 2000, description: 'Support food and medical care' }
  ];
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  <li>Your donation will help provide medical care for animals</li>
                  <li>You will receive monthly updates on the animals you support</li>
                  <li>Tax exemption certificate will be sent to your email</li>
                  <li>Thank you for making a difference in animal welfare</li>
                </ul>
              </div>
            </div>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/donationpage2" className="back-button">
...
export default ConformationDonation2;
