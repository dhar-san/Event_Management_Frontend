...
function ConformationFoodFest2() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 2200, description: 'All access with chef meet & greet' },
    { id: 'premium', name: 'Premium', price: 1700, description: 'Priority access to all food stalls', popular: true },
    { id: 'standard', name: 'Standard', price: 1200, description: 'Access to most food stalls' },
    { id: 'economy', name: 'Economy', price: 900, description: 'Basic access to food festival' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/food_fest2" className="back-button">
...
export default ConformationFoodFest2;