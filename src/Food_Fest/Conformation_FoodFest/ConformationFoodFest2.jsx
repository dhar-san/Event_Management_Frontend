...
function ConformationFoodFest2() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Foodie Pass', price: 3500, description: 'Unlimited food tasting + premium seating' },
    { id: 'standard', name: 'Standard Pass', price: 2000, description: 'Food tasting + general access', popular: true },
    { id: 'student', name: 'Student Pass', price: 1200, description: 'Discounted rate for students' }
  ];
