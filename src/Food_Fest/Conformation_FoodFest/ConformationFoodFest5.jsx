...
function ConformationFoodFest5() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Wine Pass', price: 3499, description: 'Premium wine tasting + gourmet dinner' },
    { id: 'standard', name: 'Standard Pass', price: 2200, description: 'Wine tasting + dinner', popular: true },
