...
function ConformationFoodFest5() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 2800, description: 'All access with chef meet & greet' },
    { id: 'premium', name: 'Premium', price: 2000, description: 'Priority access to all food stalls', popular: true },
    { id: 'standard', name: 'Standard', price: 1400, description: 'Access to most food stalls' },
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/food_fest5" className="back-button">
