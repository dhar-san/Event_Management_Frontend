...
function ConformationFoodFest6() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 5000, description: 'All access with chef meet & greet' },
    { id: 'premium', name: 'Premium', price: 3500, description: 'Priority access to all food stalls', popular: true },
    { id: 'standard', name: 'Standard', price: 2500, description: 'Access to most food stalls' },
    { id: 'economy', name: 'Economy', price: 1800, description: 'Basic access to food festival' }
  ];
