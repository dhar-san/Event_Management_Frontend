...
function ConformationFoodFest4() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 2000, description: 'All access with chef meet & greet' },
    { id: 'premium', name: 'Premium', price: 1500, description: 'Priority access to all food stalls', popular: true },
    { id: 'standard', name: 'Standard', price: 1000, description: 'Access to most food stalls' },
    { id: 'economy', name: 'Economy', price: 700, description: 'Basic access to food festival' }
  ];
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/food_fest4" className="back-button">
...
export default ConformationFoodFest4;