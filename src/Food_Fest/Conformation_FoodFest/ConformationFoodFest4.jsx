...
function ConformationFoodFest4() {
  ...
  const eventDetails = {
    ...
    organizer: "Sweet Treats Society",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Sweet Pass', price: 2500, description: 'Unlimited dessert tasting + premium seating' },
    { id: 'standard', name: 'Standard Pass', price: 1500, description: 'Dessert tasting + general access', popular: true },
