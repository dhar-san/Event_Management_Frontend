...
function ConformationFoodFest() {
  ...
  const eventDetails = {
    title: "Chennai Food Festival 2024",
  ...
  const packages = [
    { id: 'vip', name: 'VIP Foodie Pass', price: 2500, description: 'Unlimited food tasting + premium seating' },
    { id: 'standard', name: 'Standard Pass', price: 1500, description: 'Food tasting + general access', popular: true },
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          ...
          <div className="action-buttons">
            <Link to="/food_page" className="btn btn-primary">Browse More Food Events</Link>
        ...
        <div className="confirmation-content">
          ...
          <div className="booking-sections">
            <div className="package-selection">
              <h2>Pick Your Pass! Taste the Magic 🍕</h2>
