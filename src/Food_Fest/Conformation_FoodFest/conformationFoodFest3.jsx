...
import { FaTicketAlt, FaCreditCard, FaMobile, FaWallet, FaUniversity, FaCheck, FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaUsers, FaUtensils } from 'react-icons/fa';

function ConformationFoodFest3() {
  ...
  const eventDetails = {
    ...
    organizer: "Chef Madhampatty Rangaraj",
  ...
  const packages = [
    { id: 'vip', name: 'VIP', price: 2500, description: 'All access with chef meet & greet' },
    { id: 'premium', name: 'Premium', price: 1800, description: 'Priority access to all food stalls', popular: true },
    { id: 'standard', name: 'Standard', price: 1300, description: 'Access to most food stalls' },
    { id: 'economy', name: 'Economy', price: 1000, description: 'Basic access to food festival' }
  ];
              ...
              <div className="ticket-section">
                ...
                <div className="ticket-info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span className="value">FD{Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
                  </div>
                  <div className="info-item">
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/food_fest3" className="back-button">
...
export default ConformationFoodFest3;