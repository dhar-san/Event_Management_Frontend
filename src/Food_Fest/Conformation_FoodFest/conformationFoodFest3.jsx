...
function ConformationFoodFest3() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Foodie Pass', price: 4000, description: 'Unlimited food tasting + premium seating' },
    { id: 'standard', name: 'Standard Pass', price: 2500, description: 'Food tasting + general access', popular: true },
