...
import { FaTicketAlt, FaCreditCard, FaMobile, FaWallet, FaUniversity, FaCheck, FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaFilm } from 'react-icons/fa';

function Conformation_Movie() {
  ...
  const eventDetails = {
    ...
    organizer: "Cinema Paradise",
    venue: "PVR Cinemas, Phoenix Mall",
    date: "12th April 2024",
    time: "7:00 PM – 10:00 PM",
    image: "https://images.unsplash.com/photo-1489599804151-0b0b4b0b0b0b?w=500&h=300&fit=crop"
  };

  const packages = [
    { id: 'vip', name: 'VIP Experience', price: 800, description: 'Premium seating + popcorn + drinks' },
    { id: 'standard', name: 'Standard Ticket', price: 500, description: 'Regular seating + popcorn', popular: true },
    { id: 'student', name: 'Student Ticket', price: 300, description: 'Discounted rate for students' }
  ];
      ...
      <div className="ticket-page">
        <div className="ticket-container">
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  ...
                  <li>Keep this ticket safe and bring it to the cinema</li>
                </ul>
              </div>
            </div>
          ...
          <div className="action-buttons">
            <Link to="/movie_page" className="btn btn-primary">Browse More Movies</Link>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/movie1" className="back-button">
...
export default Conformation_Movie
