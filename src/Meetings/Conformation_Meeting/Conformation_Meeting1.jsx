...
function Conformation_Meeting1() {
  ...
  const packages = [
    { id: 'vip', name: 'VIP Networking', price: 3000, description: 'Premium seating + exclusive networking session' },
    { id: 'standard', name: 'Standard Pass', price: 1500, description: 'General admission + refreshments', popular: true },
    { id: 'student', name: 'Student Pass', price: 800, description: 'Discounted rate for students' }
  ];
      ...
      <div className="ticket-page">
        <div className="ticket-container">
          <div className="ticket-header">
            ...
            <p>Your meeting registration has been confirmed</p>
          </div>
            ...
            <div className="ticket-body">
              ...
              <div className="ticket-section">
                ...
                <ul className="info-list">
                  <li>Please arrive 15 minutes before the meeting starts</li>
                  <li>Business cards are recommended for networking</li>
          ...
          <div className="action-buttons">
            <Link to="/meeting_page" className="btn btn-primary">Browse More Meetings</Link>
    ...
    <div className="confirmation-page">
      <div className="confirmation-container">
        <div className="confirmation-header">
          <Link to="/meeting1" className="back-button">
...
export default Conformation_Meeting1
